  ...
  return (
    <div className="w-full max-w-[448px] bg-surface-container-lowest border border-outline-variant shadow-lg rounded-2xl p-6 sm:p-xl">
      ...
      <div className="flex items-center gap-sm mb-md">
        ...
        <span className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider">or sign in with email</span>
        <div className="flex-1 h-px bg-outline-variant"></div>
      </div>
      ...
      <div className="mt-lg text-center">
        <p className="font-body-md text-body-md text-on-surface-variant">
          ...
          <Link href={`/signup${searchParams.toString() ? `?${searchParams.toString()}` : ''}`} className="text-primary font-medium hover:underline">
            Sign up
          </Link>
        </p>
      </div>
