        ...
        <div className="p-10 md:p-14">
          ...
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex flex-col items-end gap-3 text-right">
              ...
              <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-xl p-4 text-right space-y-2.5 w-64 shadow-sm">
                <div>
          ...
          {/* Status + Amount Card */}
          <div className="bg-[#f0fdf4] border border-[#bbf7d0] rounded-xl py-3 px-4 mb-6 flex justify-between items-center">
