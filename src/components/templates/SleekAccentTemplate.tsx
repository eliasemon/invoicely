...
export function SleekAccentTemplate({ invoice, profile, isPreview, showGroups, showGroupTotals, publicUrl }: TemplateProps) {
  ...
  return (
 <div className="min-h-screen py-8 bg-[#f2f4f8] text-[#1a1c21] print:bg-white print:p-0 print:m-0 print:min-h-0 print:w-[210mm]" style={{ fontFamily: 'Hanken Grotesk, sans-serif' }}> {/* Floating Actions */}       {!isPreview && (
