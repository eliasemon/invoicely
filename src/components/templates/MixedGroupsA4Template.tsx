...
export function MixedGroupsA4Template({ invoice, profile }: TemplateProps) {
  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen py-8 px-4" style={{ fontFamily: 'Hanken Grotesk, sans-serif' }}>
      <div className="max-w-[800px] mx-auto bg-white shadow-md rounded-lg overflow-hidden" style={{ minHeight: '1123px' }}>
        {/* Header */}
